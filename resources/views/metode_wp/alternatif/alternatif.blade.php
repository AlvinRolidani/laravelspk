                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-4 mb-3 order-0">
                                ...
                                <a href="/metode/wp/tambah_alternatif" class="btn rounded-pill btn-primary">Tambah
                                    Alternatif </a>
                            </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="/metode/wp/{{ $item->id }}/edit_alternatif"><i
                                                                class="bx bx-edit-alt me-1"></i> Edit Alternatif</a>
                                                        <a class="dropdown-item" href="javascript:void(0);"><i
                                                                class="bx bx-trash me-1"></i> Hapus Nilai Alternatif</a>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <div class="modal fade" id="staticBackdrop{{ $item->kode_alternatif }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/metode/wp/tambah_nilai" method="post">

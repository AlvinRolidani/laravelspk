                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-4 mb-3 order-0">
                                ...
                                <a href="/metode/topsis/tambah_kriteria" class="btn rounded-pill btn-primary">Tambah
                                    Kriteria</a>
                            </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="/metode/topsis/crips/{{ $item->id }}"><i
                                                                class="bx bx-edit-alt me-1"></i> Edit Crips</a>
                                                        <a class="dropdown-item"
                                                            href="/metode/topsis/{{ $item->id }}/edit_kriteria"><i
